...
export const projects: CaseStudy[] = [
  // ── BalVoi ────────────────────────────────────────────────────────
  {
    ...
    metrics: [
      { label: "Reduction in production time", value: "45", suffix: "%" },
      { label: "Increase in article reach", value: "3", suffix: "x" },
      { label: "Journalist satisfaction (NPS)", value: "72" },
      { label: "Steps to publish", value: "14→2" },
    ],
    reflection:
      "If I could redo this project, I'd invest more time in the onboarding flow. We focused heavily on the core editor experience, but early analytics showed a 35% drop-off during first setup. The integration setup (connecting existing CMS, configuring channels) was too technical for non-technical editors. I'd design a guided setup wizard with sensible defaults.\n\nI also learned that designing for AI-augmented workflows requires a different mental model than traditional UX. The challenge isn't just usability — it's trust calibration. You have to design for the moment when AI gets it wrong, not just when it gets it right.",
    nextProject: "xygo",
  },
