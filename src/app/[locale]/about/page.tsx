    ...
    <>
      ...
      <section className="relative py-16 border-t border-line-strong">
        ...
        <div className="mx-auto max-w-[var(--max)] px-[var(--gutter)] relative z-10 grid md:grid-cols-12 gap-8">
          ...
          <Reveal from="up" delay={100} className="md:col-span-9 prose-brut text-ink text-[19px] leading-[1.6] max-w-[62ch] space-y-6">
            {bio.bio.map((p, i) => (
              <p key={i}>{p}</p>
            ))}
          </Reveal>
      ...
      <section className="relative py-20 border-t border-line-strong">
        ...
        <div className="mx-auto max-w-[var(--max)] px-[var(--gutter)] relative z-10 grid md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-9 space-y-12">
            {skills.map((group, gi) => (
              <Reveal from="up" delay={gi * 80} key={group.category}>
      ...
      <section className="relative py-20 border-t border-line-strong bg-paper-soft/60 backdrop-blur-[2px]">
        ...
        <div className="mx-auto max-w-[var(--max)] px-[var(--gutter)] relative z-10 grid md:grid-cols-12 gap-8">
          ...
          <Reveal from="right" delay={100} className="md:col-span-9">
            <p className="prose-brut text-ink text-[18px] leading-[1.65] max-w-[62ch] border-l border-acid pl-6">
              {bio.collaboration}
            </p>
          </Reveal>
        </div>
      ...
      <section className="relative py-20 border-t border-line-strong">
        ...
        <div className="mx-auto max-w-[var(--max)] px-[var(--gutter)] relative z-10 grid md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-9 space-y-12">
            {work.map((w, i) => (
              <Reveal from="up" delay={i * 80} key={w.company + w.period}>
                <article className="hairline-t pt-8">
      ...
      <section className="relative py-20 border-t border-line-strong bg-paper-soft/60 backdrop-blur-[2px]">
        ...
        <div className="mx-auto max-w-[var(--max)] px-[var(--gutter)] relative z-10 grid md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-9 grid gap-px bg-line-strong hairline-t hairline-b">
            {freelance.map((f, i) => (
              <Reveal from="up" delay={i * 80} key={f.name}>
                <article className="bg-paper-soft p-7">
